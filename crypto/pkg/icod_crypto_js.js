...
* @returns {any}
*/
export function alter_chunks_name(chunk, new_name) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.alter_chunks_name(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any[]}
*/
export function split_into_chunks(key, configuration) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(configuration, ChunksConfiguration);
        var ptr1 = configuration.__destroy_into_raw();
        wasm.split_into_chunks(retptr, ptr0, len0, ptr1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
...
* @returns {Uint8Array}
*/
export function recover_key(chunks) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(chunks, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.recover_key(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
export class ChunksConfiguration {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ChunksConfiguration.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    get required() {
        const ret = wasm.__wbg_get_chunksconfiguration_required(this.__wbg_ptr);
        return ret;
    }
    /**
    * Number of chunks required for recovery.
    ...
    */
    get spare() {
        const ret = wasm.__wbg_get_chunksconfiguration_spare(this.__wbg_ptr);
        return ret;
    }
    /**
    * Number of extra chunks.
    ...
    * @param {number} spare
    */
    constructor(required, spare) {
        const ret = wasm.chunksconfiguration_new(required, spare);
        return ChunksConfiguration.__wrap(ret);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('icod_crypto_js_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
